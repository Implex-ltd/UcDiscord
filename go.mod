...
require (
	github.com/Implex-ltd/cleanhttp v0.0.0-20230821193203-074c6c8003fb
	github.com/bogdanfinn/fhttp v0.5.23
	github.com/gorilla/websocket v1.5.0
)

require (
	github.com/Implex-ltd/fingerprint-client v0.0.0-20230830235428-380e1bbcfa4b // indirect
